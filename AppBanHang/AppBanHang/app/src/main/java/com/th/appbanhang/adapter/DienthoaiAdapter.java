...
public class DienthoaiAdapter extends BaseAdapter {
    ...
    public class  ViewHolder {
        public TextView txttendienthoai ,txtgiadienthoai,txtmotadienthoi;
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if(convertView == null)
        {
            ...
            viewHolder.txtmotadienthoi = (TextView) convertView.findViewById(R.id.textviewmotadienthoai);
        ...
        viewHolder.txtmotadienthoi.setMaxLines(2);
        viewHolder.txtmotadienthoi.setEllipsize(TextUtils.TruncateAt.END);
        viewHolder.txtmotadienthoi.setText(sanpham.getMotasanpham());
